...
@section('content')
<div class="container-fluid" ng-app="create" ng-controller="clientController">
	<div class="panel panel-primary">
		<div class="panel-heading">
			Formulis Pendaftaran
		</div>
		<div class="panel-body">
			<form class="form" method="post" action="{{url('admin/client/store')}}">
				<div class="row">
					<div class="col-sm-6">
					...
					<div class="col-sm-6">
						...
						<div class="form-group">
							...
							<input type="test" class="form-control" name="profession" required>
						</div>
						<div class="form-group">
...
<script type="text/javascript">
	...
	create.controller('clientController',['$scope','$http',function($scope,$http){
		$scope.todos = [];
		$scope.init = function(){

...
<div class="container-fluid" ng-app="create" ng-controller="AdminController">
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<form class="form" method="post" action="{{url('admin/admin/update')}}">
				<div class="row">
					<div class="col-sm-6">
					...
					<div class="col-sm-6">
						...
						<div class="form-group">
							...
							<input type="number" class="form-control" name="cp" value="{{ $admin->biodata->cp }}" required>
						</div>
						<div class="form-group">
							<label class="label label-primary">Tanggal lahir</label>
							<input type="date" class="form-control" name="date_of_birth" value="{{ $admin->biodata->date_of_birth }}" required>
						</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="home_address" value="{{ $admin->biodata->home_address }}" required>
						</div>
						<div class="form-group">
							<label class="label label-primary">Pendidikan Terakhir</label>
							<input type="text" class="form-control" name="last_education" value="{{ $admin->biodata->last_education }}" required>
						</div>
						<div class="form-group">
							<label class="label label-primary">Profesi</label>
							<input type="test" class="form-control" name="profession" value="{{ $admin->biodata->profession }}" required>
						</div>
						<div class="form-group">
							<label class="label label-primary">Skill</label>
							<input type="text" class="form-control" name="skill" value="{{ $admin->biodata->skill }}" required>
						</div>
					</div>
				</div>
